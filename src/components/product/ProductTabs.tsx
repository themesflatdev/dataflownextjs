                        ...
                        <div className={`reply-comment style-1 cancel-review-wrap ${openReviewForm ? "d-none" : "d-block"
                            ...
                            <div className="reply-comment-wrap">
                                <div className="reply-comment-item">
                                    <div className="user">
                                        <div className="image">
                                            <img src="/images/avatar/user-default.jpg" alt="image" />
                                        </div>
                                        <div>
                                            <div className="h6">
